...
import logoDeutscheBank from '@/images/logos/db.png'
import logoUSC from '@/images/logos/usc.webp'
...
function Photos() {
  ...
  return (
    <div className="mt-16 sm:mt-20">
      <div className="-my-4 xl:justify-center flex gap-5 overflow-x-auto py-4 sm:gap-8">
        {[image1, image2, image3, image4, image5].map((image, imageIndex) => (
          <div
            key={image.src}
            className={clsx(
              'relative aspect-[9/10] w-44 flex-none overflow-clip rounded-xl bg-zinc-100 dark:bg-zinc-800 sm:w-72 sm:rounded-2xl',
